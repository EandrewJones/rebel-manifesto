...
from src.scrapers import MoldovaPMRScraper
import json
import logging
...
if __name__ == '__main__':
    ...
    logging.basicConfig(
        level=logging.INFO,
        filename='logs/scrape_pmr.log',
        filemode='w',
        format='%(name)s - %(levelname)s - %(message)s'
    )

    # Instantiate scraper
    with open('webscraping/params/pmr_params.json') as infile:
        params = json.load(infile)

    scraper = MoldovaPMRScraper(**params)
